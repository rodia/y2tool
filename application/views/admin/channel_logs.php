        ...
        <?php if ( ! empty($logs)) : ?>
            <?php foreach ($logs as $key => $row) : ?>
                <tr<?php echo ($key % 2) ? " class=\"alternate-row\"" : ""; ?>>
                    ...
                    <td class="number"><?php echo print_likes($row->video_id, $user_id, $this); ?></td><!-- Current No. of Likes -->
                    ...
                    <td class="number"><?php echo print_current_views($row->video_id, $user_id, $this); ?></td><!-- No. Current Views -->
