        ...
        <?php foreach ($playlistListFeed as $key => $playlistListEntry) : ?>
            <tr<?php echo $key % 2 == 0 ? " class=\"alternate-row\"" : ""; ?>>
                ...
                <td class="">
                    ...
                    <a href="<?php echo base_url(); ?>video/delplaylist/<?php echo $user_id; ?>/<?php echo $playlistListEntry["id"]; ?>" onclick="return confirm('Are you sure remove this playlist?');"><b>Remove playlist</b></a><br/>
                </td>
            </tr>
            <?php endforeach; ?>
    </table>
