...
<center>
    ...
    echo form_open("video/processliking", $attributes)
    ?>
    <table width="800" cellspacing="0" cellpadding="0" border="0" id="product-table">
        ...
        <tr class="alternate-row">
            ...
            <td  colspan="2">
                ...
                <div id="like_inputs">
                    <p>
                        <label for="video_id"><span>Video ID 1 * </span><input type="text" class="inp-form" size="50" name="video_ids[]" value="" placeholder="Enter youtube video id" /></label>
